...
1. **Load the plan:**
   - Read `_output/tracking/pert-chart.md` (SACRED) — expected wave schedule and critical path
   - Read `_output/tracking/sprint-plan.yaml` — current sprint scope and goals
