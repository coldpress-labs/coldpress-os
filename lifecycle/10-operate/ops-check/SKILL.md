...
inputs:
  - "_context/planning/outcomes.yaml (the P4 outcome contract — targets + sources)"
  - "the deploy pack's connectors (analytics / uptime / error / cert / backup)"
  - "the shipped lockfile (for CVE re-scan)"
outputs:
  - artifact: "Ops digest (actual-vs-target)"
    location: "_context/operations/ops-digests/ops-{date}.md"
    format: "markdown"
---
