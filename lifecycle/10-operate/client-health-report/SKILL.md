...
tools: ["Read", "Write"]
inputs:
  - "the month's _context/operations/ops-digests/ops-*.md (from ops-check)"
  - "_context/planning/outcomes.yaml (targets) + any incident/correct-course records"
outputs:
  - artifact: "Client health report"
    location: "_context/operations/health-reports/health-{month}.md"
    format: "markdown"
---
