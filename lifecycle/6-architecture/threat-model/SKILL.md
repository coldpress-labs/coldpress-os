...
inputs:
  cold_file_reads:
    - "_context/sacred/architecture.md (components + trust boundaries)"
    - "_context/architecture/security-registry.yaml (the sensitive paths to threat-model)"
    - "_context/architecture/integration-inventory.yaml (external trust boundaries)"
outputs:
  - artifact: "Threat model"
    location: "_context/architecture/threat-model.yaml"
    format: "yaml"
    schema: "schemas/architecture/p6-artifacts.schema.ts (ThreatModelSchema)"
    sacred: false
version: "1.0"
---
