...
inputs:
  graph_queries:
    - "ArchitectureComponent nodes"
    - "ArchitectureComponent neighbors (relation: integrates_with / depends_on)"
  cold_file_reads:
    - "_context/sacred/architecture.md"
    - "_context/sacred/architecture.meta.json"
    - "_context/planning/adrs/adr-*-v*.md"
  existence_checks:
    - "_context/sacred/architecture.md (locked == true)"
    - "_context/sacred/architecture.meta.json"
outputs:
  - artifact: "Mermaid diagrams (markdown-embedded)"
    location: "_context/design/diagrams/architecture-mermaid-v{N}.md"
    format: "markdown"
    sacred: false
  - artifact: "PlantUML diagrams"
    location: "_context/design/diagrams/architecture-plantuml-v{N}/"
    format: "plantuml"
    sacred: false
  - artifact: "Diagram index"
    location: "_context/design/diagrams/index-v{N}.md"
    format: "markdown"
    sacred: false
---
