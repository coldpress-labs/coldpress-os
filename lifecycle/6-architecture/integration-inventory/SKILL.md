...
tools: ["Read", "Write"]
inputs:
  - "_context/sacred/architecture.md + tech-stack.md"
outputs:
  - artifact: "integration-inventory"
    location: "_context/architecture/integration-inventory.yaml"
    format: "yaml"
    schema: "schemas/architecture/p6-artifacts.schema.ts (IntegrationInventory)"
version: "1.0"
---
