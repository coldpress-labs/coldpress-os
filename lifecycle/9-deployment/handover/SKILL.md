...
inputs:
  - "secure/manifest.yaml; the selected deploy pack; _context/sacred/*; the SBOM + license inventory from readiness"
outputs:
  - artifact: "Client handover pack"
    location: "_context/operations/handover/"
    format: "markdown"
---
