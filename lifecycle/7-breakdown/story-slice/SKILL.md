...
inputs:
  - "HND-p6 packet: PRD requirements × components × styleguide inventory"
  - "_context/sacred/{prd,architecture}.md; _context/architecture/{api-contract,security-registry.yaml,analytics-plan}; _context/design/{tokens.json,styleguide.md,ux-spec.md}"
outputs:
  - artifact: "Epics (user-value grouping)"
    location: "_context/planning/epics-v{N}.md"
    format: "markdown"
  - artifact: "Per-story files (contracts)"
    location: "_context/implementation/stories/ST-*.md"
    format: "markdown"
  - artifact: "Stories index"
    location: "_context/implementation/stories/stories-index.md"
    format: "markdown"
version: "1.0"
---
