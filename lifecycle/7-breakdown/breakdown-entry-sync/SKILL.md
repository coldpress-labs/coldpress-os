...
inputs:
  graph_queries:
    ...
    - "adrs"
  cold_file_reads:
    - "_context/handoffs/phase-6-to-7-{date}.md"
  ...
  existence_checks:
    ...
    - "phase-6-to-7 handoff exists"
outputs:
  - artifact: "Breakdown Scope Memo"
    location: "_context/planning/breakdown-scope-v{N}.md"
    format: "markdown"
    sacred: false
    distillate: true
    schema: "schemas/planning-artefacts/breakdown-scope.schema.json"
  - artifact: "PRD v(N+1) (conditional — emitted if any architecture_delta resolved as accept_into_prd)"
    location: "_context/sacred/prd.md (VC bumped)"
