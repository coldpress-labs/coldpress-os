...
inputs:
  cold_file_reads:
    - "the verifier HND packet (spec_ref + acceptance_ref + diff_ref + owns) — Butler-dispatched"
    - "_context/implementation/stories/{story}.md (the story contract)"
outputs:
  - artifact: "Verifier packet"
    location: "_context/handoffs/verify-{story}-packet.yaml"
    format: "yaml"
    schema: "schemas/operations/verifier-verdict.schema.ts (VerifierPacketSchema)"
    sacred: false
  - artifact: "Verdict record"
    location: "_context/audit/verdicts/{story}-verdict.yaml"
    format: "yaml"
    schema: "schemas/operations/verifier-verdict.schema.ts (VerifierVerdictSchema)"
    sacred: false
version: "1.0"
---
