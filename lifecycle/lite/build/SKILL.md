...
inputs:
  - "_context/sacred/spec.md (scoped to the requirements being built)"
  - "_context/design/tokens.json + styleguide.md (if UI)"
outputs:
  - artifact: "implementation"
    location: "src/ (project code)"
    format: "code"
  - artifact: "acceptance stubs"
    location: "_context/implementation/*.tests.md + test files"
    format: "code"
version: "1.0"
---
