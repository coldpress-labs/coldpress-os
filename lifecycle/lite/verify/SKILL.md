...
inputs:
  - "spec (acceptance) + the diff — NEVER the developer's reasoning"
  - "_context/design/tokens.json (if UI)"
outputs:
  - artifact: "verifier verdict"
    location: "_context/audit/verify-{story}-{date}.md"
    format: "markdown"
version: "1.0"
---
