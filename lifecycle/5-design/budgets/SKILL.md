...
inputs:
  cold_file_reads:
    - "_context/design/ux-design-spec-v{N}.md (device/viewport + interaction targets)"
    - ".coldpress/local-config.yaml (active a11y baseline → WCAG level)"
    - "_context/planning/outcomes.yaml (any latency/perf outcome targets to align with)"
outputs:
  - artifact: "Performance + a11y budgets"
    location: "_context/design/budgets.yaml"
    format: "yaml"
