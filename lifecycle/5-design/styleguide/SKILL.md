...
inputs:
  cold_file_reads:
    - "_context/design/tokens.json (the roles/scale the route renders)"
    - "_context/design/ux-design-spec-v{N}.md (the components per screen)"
outputs:
  - artifact: "Styleguide manifest"
    location: "_context/design/styleguide.yaml"
    format: "yaml"
    schema: "schemas/design/styleguide.schema.ts"
    sacred: false
  - artifact: "Live styleguide route (code)"
    location: "app /styleguide route + visual-baselines dir"
    format: "code"
    sacred: false
version: "1.0"
---
