...
| [product-brief](product-brief/) | workflow | analyst | Step 1 consolidates research + validation into a versioned synthesis artefact (Tier 1: Systems Thinking, Morphological Analysis; wires docs (op: distill), adversarial-review, editorial); Steps 2-5 distil it into a validated-distillate executive brief (versioned, regeneratable — not sacred) |
