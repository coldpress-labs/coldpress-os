...
inputs:
  ...
  - "_context/planning/research/*.md (all research lane outputs)"
  - "_context/tracking/intake-{date}.md"
  - ".coldpress/graph/graph.json"
  - ".coldpress/local-config.yaml (for user.team_shape)"
  - "data/methods/problem-solving-methods.csv"
  - "data/methods/innovation-frameworks.csv"
  - "data/methods/design-thinking-methods.csv"
outputs:
  - artifact: "Idea Validation"
    location: "_context/planning/idea-validation-v{N}.md"
    format: "markdown"
    versioned: true
  - artifact: "Validation Decision Log (Step 9)"
    location: "_context/audit/validation-decisions-{date}.md"
    format: "markdown"
    append_only: true
  - artifact: "Client Signoff (Step 8, conditional)"
    location: "_context/audit/client-signoffs/validation-{date}.md"
    format: "markdown"
version: "1.0"
---
