...
inputs:
  cold_file_reads:
    - "_context/sacred/prd.md (numbered requirements + priority P0-P3)"
    - "_context/planning/product-brief-v{N}.md (north-star + guardrail metrics)"
    - "_context/planning/idea-validation-v{N}.md (north_star_metric + leading_indicators)"
outputs:
  - artifact: "Outcome contract"
    location: "_context/planning/outcomes.yaml"
    format: "yaml"
