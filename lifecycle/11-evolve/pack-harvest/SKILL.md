...
inputs:
  - "the shipped project (real, working artifacts) + its profile/stack/deploy packs"
  - "the retrospective (what worked well)"
outputs:
  - artifact: "Pack-harvest proposal + graduated assets"
    location: "_context/audit/pack-harvest-v{N}.md (→ PRs against the pack)"
    format: "markdown"
---
