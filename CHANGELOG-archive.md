# Changelog — Archive (pre-0.3)

Historical changelog entries for releases **before 0.3.0-alpha**, split out
of the main `CHANGELOG.md` to keep it lean (WS11 S2). Not shipped in the npm
package. The current changelog (0.3.0-alpha onward + Unreleased) lives in
`CHANGELOG.md`.
