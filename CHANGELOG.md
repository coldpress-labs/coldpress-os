...
- `_input/` scaffold in `install/project-template/` with `raw/`, `legacy/`, `reference/`, `vendor/`, `assets/` subfolders. Consumer projects have a clear place to drop source material distinct from produced artefacts.
