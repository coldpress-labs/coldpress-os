...
The PERT chart at `_output/tracking/pert-chart.md` is a **sacred document**. Changes to it trigger the PERT change governance workflow which assesses downstream impact on sprint planning and wave execution.
