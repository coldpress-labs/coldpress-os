...
User requests a change to `_output/planning/prd.md` after it has been created and validated in Phase 4.
...
|--------------------|-----------|
| Architecture (`_output/planning/architecture.md`) | System design, component boundaries, data model |
