...
D38–D39) · **S1.c+d 🟢** (`overhaul/ws11-s1-cli-hygiene`, D40–D41). Remaining:
S1.e (CLAUDE.md draft — user approval), S2–S6, guards.
...
**Next in WS11:** S1.e (framework-repo CLAUDE.md — **draft for user approval before merge**); then S2 package hygiene, S3/S3.5 deletions + staleness lint, S5 regeneration, S4 wire-or-archive, S6 scaffold diet, and the §S7.7 structure guard.
