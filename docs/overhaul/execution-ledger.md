...
fixes + staleness lint; httpx fixture shrink deferred). Next: S5 regen (also clears
the staleness lint's S5-skip-list), S4 wire-or-archive, S6 scaffold diet, guards.
