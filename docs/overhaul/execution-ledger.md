...
**S2 in progress:** S2.1 🟢 (`overhaul/ws11-s2-package-hygiene`, D43 — docs/overhaul
no longer ships/scaffolds). Remaining S2: working-notes archive, §8.14 templates
prune+rename, seo-pack reclassification, CHANGELOG trim. Then S3/S3.5 + staleness
lint, S5 regen, S4 wire-or-archive, S6 scaffold diet, guards.
