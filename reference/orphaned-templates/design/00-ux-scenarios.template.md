...
**Agents:** Analyst (@analyst — Scenario Outline), UX Designer (@ux-designer — Page Specifications)
...
### Scenario Outline (@analyst)
**Workflow:** `skill:wds-3-scenarios`
**Agent trigger:** `SC` (@analyst)

### Page Specifications (@ux-designer)
**Workflow:** `skill:wds-4-ux-design`
**Agent trigger:** `UX` (@ux-designer)
...
**Quality guide:** `./resources/agent-guides/ux-designer/specification-quality.md`
**Object types:** `./resources/wds-4-ux-design/object-types/`

### Specification Audit (@ux-designer)
**Workflow:** `skill:wds-4-ux-design`
**Agent trigger:** `SA` (@ux-designer)
