...
inputs:
  graph_queries:
    - "source data node (sprint-status / dep-audit / retrospective table)"
  cold_file_reads:
    - "source structured data (YAML / JSON / CSV path passed by caller)"
  existence_checks:
    - "source data file exists"
    - "exceljs in dev-deps"
outputs:
  - artifact: "XLSX"
    location: "_context/exports/<source-slug>-v{N}.xlsx"
    format: "xlsx"
    sacred: false
---
