...
inputs:
  graph_queries:
    - "Page nodes (location pages)"
  cold_file_reads:
    - "_context/sacred/context.md (business locations + service-area)"
    - "_context/planning/personas-*.md (local persona search-intents)"
    - "_input/legacy/business-info.* (NAP source-of-truth if brownfield)"
  existence_checks:
    - "Project archetype includes 'local-business' OR 'service-area-business'"
outputs:
  - artifact: "NAP-consistency audit"
    location: "_context/audit/seo-local-nap-v{N}.md"
    format: "markdown"
    sacred: false
  - artifact: "GBP optimisation checklist"
    location: "_context/audit/seo-local-gbp-v{N}.md"
    format: "markdown"
    sacred: false
  - artifact: "Citation-building plan"
    location: "_context/planning/seo-local-citations-v{N}.md"
    format: "markdown"
    sacred: false
  - artifact: "Location-page templates"
    location: "_context/design/seo-local-pages/<location-slug>-template-v{N}.md"
    format: "markdown"
    sacred: false
---
