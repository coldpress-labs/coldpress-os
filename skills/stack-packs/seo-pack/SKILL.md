...
inputs:
  graph_queries:
    - "personas (target search intents)"
    - "tech-stack (frontend framework — affects schema injection)"
  cold_file_reads:
    - "_context/sacred/context.md (project goals + audience)"
    - "_context/sacred/architecture.md (server-side rendering capability)"
  existence_checks:
    - "coldpress.yaml baselines.seo defined"
outputs:
  - artifact: "Pack-level SEO strategy"
    location: "_context/planning/seo-strategy-v{N}.md"
    format: "markdown"
    sacred: false
---
