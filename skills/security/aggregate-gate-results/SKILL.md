...
inputs:
  - "_context/audit/security/<scanner>-<date>.json × N"
  - "optional .coldpress/signoffs/security-gate/<finding-id>.yaml waivers"
outputs:
  - artifact: "AggregateResult"
    location: "_context/audit/security/aggregate-{date}.json"
    format: "json"
version: "1.0"
---
