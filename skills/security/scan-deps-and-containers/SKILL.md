...
inputs:
  - "project root with dep manifests (package.json, Cargo.toml, go.mod, requirements.txt, …)"
  - "optional container image tag or Dockerfile"
outputs:
  - artifact: "Trivy scan result"
    location: "_context/audit/security/trivy-{date}.json"
    format: "json"
version: "1.0"
---
