...
5. **Write `_context/audit/docs/source-tree.md`** immediately.

## Output

Source tree documentation written to `_context/audit/docs/source-tree.md`. Update frontmatter: `step_3_complete: true`
