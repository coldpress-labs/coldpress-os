...
inputs:
  graph_queries:
    - "UxScreen nodes (Phase 5 design output)"
    - "BrandToken nodes (color contrast verification)"
    - "Baseline nodes (a11y axis policy)"
  cold_file_reads:
    - "_context/design/ux-design-spec-v{latest}.md"
    - "_context/design/brand-guidelines-v{latest}.md"
    - "coldpress.yaml (baselines.a11y)"
    - "_context/sacred/architecture.md (a11y NFR section)"
  existence_checks:
    - "coldpress.yaml baselines.a11y level set (A / AA / AAA)"
    - "If Phase 8 invocation: implemented code under sandbox/ or live/"
outputs:
  - artifact: "A11y audit report"
    location: "_context/audit/a11y-audit-v{N}.md"
    format: "markdown"
    sacred: false
  - artifact: "Per-violation remediation list"
    location: "_context/audit/a11y-violations-v{N}.json"
    format: "json"
    sacred: false
---
