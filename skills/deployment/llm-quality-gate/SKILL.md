...
inputs:
  - "project source with prompts/agents"
  - "coldpress.yaml `eval.deepeval:` + `eval.targets[]` blocks"
outputs:
  - artifact: "DeepEval ScanResult"
    location: "_context/audit/security/deepeval-{date}.json"
    format: "json"
version: "1.0"
---
