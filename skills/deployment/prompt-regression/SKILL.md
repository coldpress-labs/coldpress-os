...
inputs:
  - "`promptfooconfig.yaml` at project root (or custom path via `eval.promptfoo.config_path`)"
outputs:
  - artifact: "Promptfoo ScanResult"
    location: "_context/audit/security/promptfoo-{date}.json"
    format: "json"
version: "1.0"
---
