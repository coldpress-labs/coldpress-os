...
inputs:
  - "project LLM endpoints/agents declared in `eval.targets[]`"
  - "`eval.giskard` config (checks + fail_severity)"
outputs:
  - artifact: "Giskard ScanResult"
    location: "_context/audit/security/giskard-{date}.json"
    format: "json"
version: "1.0"
---
