...
1. **Check for `_context/sacred/prd.md`.** If missing, halt and inform user to complete Phase 4 first.
2. **Check for `_context/sacred/architecture.md`.** If missing, halt and inform user.
