...
```
UX Designer (@ux-designer) → Architect (@architect)
...
- Status: In Development (@developer)
- Handed off: [Date]
...
```
Weekly Update to Architect (@architect):
...
Week 2: Handoff Flow 1 → @developer builds Flow 1
        Design Flow 2
Week 3: Handoff Flow 2 → @developer builds Flow 2
        Test Flow 1 (Phase 5 [T])
        Design Flow 3
Week 4: Handoff Flow 3 → @developer builds Flow 3
